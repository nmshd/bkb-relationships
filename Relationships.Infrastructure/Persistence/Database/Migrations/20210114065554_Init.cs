        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedByDevice = table.Column<string>(type: "nvarchar(20)", nullable: false),
                    MaxNumberOfRelationships = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "char(20)", nullable: false),
                    RelationshipTemplateId = table.Column<string>(type: "char(20)", nullable: true),
                    From = table.Column<string>(type: "char(36)", nullable: false),
                    To = table.Column<string>(type: "char(36)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Req_CreatedBy = table.Column<string>(type: "nvarchar(36)", nullable: false),
                    Req_CreatedByDevice = table.Column<string>(type: "nvarchar(20)", nullable: false),
                    Res_CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Res_CreatedBy = table.Column<string>(type: "nvarchar(36)", nullable: true),
                    Res_CreatedByDevice = table.Column<string>(type: "nvarchar(20)", nullable: true),
